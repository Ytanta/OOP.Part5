...
public class BookingPresenter implements ViewObserver {
    ...
    public void updateUIShowshowСhangeReservationTable(int reservationNo, int numberNo) {
        view.showСhangeReservationTable(reservationNo, numberNo);
    }
    ...
    public void onUpdateReservetionTable(int oldReservation, Date reservationDate, int tableNo,
        ...
        try {
            int newReservationNumber = model.changeReservationTable(oldReservation, reservationDate, tableNo,
                    name);
            updateUIShowshowСhangeReservationTable(newReservationNumber, tableNo);
        } catch (RuntimeException e) {
